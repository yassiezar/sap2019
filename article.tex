...
\begin{abstract}
	...
	The secondary goal is to determine how variations to the pitch rate of change of the pitch affects a user's performance.
...
To this end, we are developing a mobile navigation system using a Google Project Tango tablet device\footnote{https://web.archive.org/web/20170714185918/https://developers.google.com/tango/}, pictured in \cref{fig:tango-headphone}, that caters to the perception limitations of people with vision impairments by using a non-visual interface.
...
where $b$ and $c$ for each setting can be calculated with the given setting's pitch and angle limits and a linear graph equation (i.e.\ $f - f_1 = b(\theta - \theta_1), b=\frac{\Delta f}{\Delta\theta}$).
