...
\acmConference[SAP '19]{Barcelona '19: ACM Symposium on Applied Perception}{September 2019}{Barcelona, Spain}
%\acmVolume{9}
%\acmNumber{4}
%\acmArticle{39}
%\acmYear{2010}
...
\begin{figure}
  ...
  \Description{A pictures of the Tango device and bone conducting headset and another of them both in-use. }
\end{figure}
...
\begin{figure}
  ...
  \Description{A diagram of the device's frame of reference. }
\end{figure}
...
\begin{figure}
  ...
  \Description{Diagram of the system pipeline.  }
\end{figure}
...
\begin{figure}
  ...
  \Description{Plots showing the 3 different pitch gradient settings. }
\end{figure}
...
%\begin{figure}
  %\centering
  %\includegraphics[width=0.4\columnwidth]{figures/vi_participant.pdf}
  %\caption{A picture of the Tango device and bone-conducting headphones in use during an experiment.}\label{fig:participant}
%\end{figure}
...
%\begin{figure}
  ...
  %\Description{Angular error results for the low setting.}
%\end{figure}
...
%\begin{figure}
  ...
  %\Description{Angular error results for the medium setting.}
%\end{figure}

%\begin{figure}
  %\centering
  %\includegraphics[clip, trim=450 0 450 110, width=0.8\columnwidth]{figures/err_hi.png}
  %\caption{Angular error data for the $m_h$ setting. }\label{fig:err-results-hi}
  %\Description{Angular error results for the high setting.}
%\end{figure}
...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.8\columnwidth}
    \centering
    \includegraphics[clip, trim=450 0 450 110, width=1.0\columnwidth]{figures/err_lo.png}
    \caption{Results for the $m_l$ setting. }\label{fig:err-results-lo}
  \end{subfigure}
  \begin{subfigure}[t]{0.8\columnwidth}
    \centering
    \includegraphics[clip, trim=450 0 450 110, width=1.0\columnwidth]{figures/err_med.png}
    \caption{Results for the $m_m$ setting. }\label{fig:err-results-med}
  \end{subfigure}
  \begin{subfigure}[t]{0.8\columnwidth}
    \centering
    \includegraphics[clip, trim=450 0 450 110, width=1.0\columnwidth]{figures/err_hi.png}
    \caption{Results for the $m_h$ setting. }\label{fig:err-results-hi}
  \end{subfigure}
  \caption{Angular error data for the 3 gradient settings. }\label{fig:err-results}
  \Description{Angular error results  for the 3 different gradient settings.}
\end{figure}
...
%\begin{figure}
  ...
  %\Description{Angular error medians for each gradient setting. }
%\end{figure}
...
%\begin{figure}
  ...
  %\Description{Angular error standard deviations for each gradient setting. }
%\end{figure}
...
\begin{figure}
  ...
  \begin{subfigure}[t]{1.0\columnwidth}
    \centering
    \includegraphics[clip, trim=20 -70 100 100, width=1.0\columnwidth]{figures/err_boxplot_medians.png}
    \caption{The medians. }\label{fig:err-boxplot-median}
  \end{subfigure}
  \begin{subfigure}[t]{1.0\columnwidth}
    \centering
    \includegraphics[clip, trim=80 -70 100 0, width=1.0\columnwidth]{figures/err_boxplot_std.png}
    \caption{The standard deviations. }\label{fig:err-boxplot-std}
  \end{subfigure}
  \caption{Boxplots for the error medians and standard deviations. }\label{fig:err-boxplot}
  \Description{A set of boxplots showing the spread of the error standard deviations and medians. }
\end{figure}
