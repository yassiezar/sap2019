...
\begin{table}
  ...
  \begin{tabular}{llcccc}
    ...
    & \emph{lo}  & 0.23 & -0.02 & 0.32 & 0.75 \\%\cmidrule{2-6}
    Pan & \emph{med} & 0.21 & -0.01 & 0.28 & 0.77 \\%\cmidrule{2-6}
    & \emph{hi}  & 0.22 & -0.05 & 0.31 & 0.75 \\\midrule
    & \emph{lo}  & 0.40 & -0.14 & 0.46 & 0.38 \\%\cmidrule{2-6}
    Tilt & \emph{med} & 0.32 & -0.12 & 0.36 & 0.48 \\%\cmidrule{2-6}
