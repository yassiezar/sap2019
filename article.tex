...
\end{figure}
  %\end{subfigure}%
  %\caption{Plots showing the distribution of angular errors in the pan and tilt dimensions for the 3 different pitch gradient settings and summarised in a set of boxplots. }
%\label{fig:err}
%\end{figure}
...
\end{figure}
  %\end{subfigure}
  %\caption{Boxplots of pan and tilt error results from the target search experiment.}
